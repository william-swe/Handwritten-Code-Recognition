        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": [
                        {"type": "text", "text": prompt},
                        {"type": "image_url", "image_url": {"url": f"data:image/png;base64,{encode_image('images/compressed/examples_6_comp.png')}", "detail": "high"}}
                    ]
                },
                {
                    "role": "assistant",
                    "content": gt_examples_6
                },
                {
                    "role": "user",
                    "content": [
                        {"type": "text", "text": prompt},
                        {"type": "image_url", "image_url": {"url": f"data:image/png;base64,{encode_image('images/compressed/examples_7_comp.png')}", "detail": "high"}}
                    ]
                },
                {
                    "role": "assistant",
                    "content": gt_examples_7
                },
                {
                    "role": "user",
                    "content": [
